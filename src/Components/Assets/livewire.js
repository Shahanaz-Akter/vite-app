!(function (global, factory) {
    ...
    classof = toStringTagSupport
      ...
      : function (it) {
          ...
          return void 0 === it
            ...
            ? "Null"
            : "string" ==
              typeof (tag = tryGet((O = $Object$3(it)), TO_STRING_TAG$3))
            ? tag
            : CORRECT_ARGUMENTS
            ? classofRaw(O)
            : "Object" == (result = classofRaw(O)) && isCallable(O.callee)
            ? "Arguments"
            : result;
        },
    $String$3 = String,
  ...
  var internalState = {
    ...
    f$4 = descriptors
      ...
      : function (O, P) {
          if (((O = toIndexedObject(O)), (P = toPropertyKey(P)), ie8DomDefine))
            try {
        ...
        (anyNativeIterator &&
          ...
          (objectGetPrototypeOf(CurrentIteratorPrototype) !==
            ...
            (objectSetPrototypeOf
              ...
              : isCallable(CurrentIteratorPrototype[ITERATOR$4]) ||
                defineBuiltIn(
                  CurrentIteratorPrototype,
                  ITERATOR$4,
                  returnThis
        ...
        ? function (target, source) {
            for (
              ...
              for (
                ...
                (key = keys[j++]),
                  (descriptors &&
                    !functionCall(propertyIsEnumerable, S, key)) ||
                    (T[key] = S[key]);
            return T;
          }
        : $assign;
  ...
  toStringTagSupport ||
    defineBuiltIn(Object.prototype, "toString", objectToString, { unsafe: !0 });
  var engineIsNode = "process" == classofRaw(global_1.process),
    ...
    speciesConstructor = function (O, defaultConstructor) {
      ...
      return void 0 === C || isNullOrUndefined((S = anObject(C)[SPECIES$1]))
        ? defaultConstructor
        : aConstructor(S);
    },
  ...
  var task$1 = { set: set, clear: clear },
    engineIsIosPebble =
      /ipad|iphone|ipod/i.test(engineUserAgent) && void 0 !== global_1.Pebble,
  ...
  var SPECIES = wellKnownSymbol("species"),
    ...
    dispatchEvent = function (name, promise, reason) {
      ...
      DISPATCH_EVENT
        ...
        !NATIVE_PROMISE_REJECTION_EVENT && (handler = global_1["on" + name])
          ? handler(event)
          ...
          result = perform(function () {
            ...
            iterate(iterable, function (promise) {
              var index = counter++,
                alreadyCalled = !1;
              remaining++,
                functionCall($promiseResolve, C, promise).then(function (
                  value
                ) {
                  alreadyCalled ||
                    ((alreadyCalled = !0),
    ...
    component.genericLoadingEls.forEach(function (element, index) {
      ...
      Object.keys(component.targetedLoadingElsByAction).forEach(function (key) {
        component.targetedLoadingElsByAction[key] =
          component.targetedLoadingElsByAction[key].filter(function (element) {
      ...
      store$2.registerHook("message.received", function (message, component) {
        component.dirtyEls.forEach(function (element) {
          element.__livewire_dirty_cleanup &&
            (element.__livewire_dirty_cleanup.forEach(function (cleanup) {
              return cleanup();
            }),
